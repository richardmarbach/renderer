...
pub const Mesh = struct {
    ...
    pub fn init_cube(texture: *const Texture) !Mesh {
        ...
        const faces = [_]Face{
            // Front
            .{ .a = 1, .b = 2, .c = 3, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 0.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 1.0 }, .color = 0xFFFFFFFF },
            .{ .a = 1, .b = 3, .c = 4, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 1.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 0.0 }, .color = 0xFFFFFFFF },
            // right
            .{ .a = 4, .b = 3, .c = 5, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 0.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 1.0 }, .color = 0xFFFFFFFF },
            .{ .a = 4, .b = 5, .c = 6, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 1.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 0.0 }, .color = 0xFFFFFFFF },
            // back
            .{ .a = 6, .b = 5, .c = 7, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 0.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 1.0 }, .color = 0xFFFFFFFF },
            .{ .a = 6, .b = 7, .c = 8, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 1.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 0.0 }, .color = 0xFFFFFFFF },
            // left
            .{ .a = 8, .b = 7, .c = 2, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 0.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 1.0 }, .color = 0xFFFFFFFF },
            .{ .a = 8, .b = 2, .c = 1, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 1.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 0.0 }, .color = 0xFFFFFFFF },
            // top
            .{ .a = 2, .b = 7, .c = 5, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 0.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 1.0 }, .color = 0xFFFFFFFF },
            .{ .a = 2, .b = 5, .c = 3, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 1.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 0.0 }, .color = 0xFFFFFFFF },
            // bottom
            .{ .a = 6, .b = 8, .c = 1, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 0.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 1.0 }, .color = 0xFFFFFFFF },
            .{ .a = 6, .b = 1, .c = 4, .a_uv = .{ .u = 0.0, .v = 0.0 }, .b_uv = .{ .u = 1.0, .v = 1.0 }, .c_uv = .{ .u = 1.0, .v = 0.0 }, .color = 0xFFFFFFFF },
        };
